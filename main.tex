...
\newcommand{\coNL}{\mathsf{co}\text{-}\mathsf{NL}}
...
\input{notes/undecidability.tex}

\chapter{Reducibility}
\input{notes/reducibility.tex}

\chapter{Computation History Method}
\input{notes/comphist.tex}

\chapter{Information}
\input{notes/kolmogorov.tex}

\part{Complexity Theory}

\chapter{Time Complexity}
\input{notes/time.tex}

\chapter{The Cook-Levin Theorem}
\input{notes/cook-levin.tex}

\chapter{NP-Complete Problems}
\input{notes/np-complete.tex}

\chapter{Space Complexity}
\input{notes/space.tex}

\chapter{The Class L and NL}
\input{notes/logspace.tex}
